...
class EditAddress extends StatefulWidget {
  final dynamic info;
  const EditAddress({Key key, this.info}) : super(key: key);
  @override
...
class _EditAddressState extends State<EditAddress> {
  ...
  void initState() {
    ...
    _vtelController.text = widget.info['tel'];
    _vareaController.text = (widget.info['area'] as String).split(',')[0];
    _vaddrController.text = widget.info['address'];
    _isDefault = widget.info['default'] == "1" ? true : false;
    _area = widget.info['area'];
    _areaId = (widget.info['area'] as String).split(',')[1];
  ...
  _savePressed() async {
    ...
    //发送 保存 请求
    var res = await Api.getInstance().updateAddress(widget.info['id'], _vnameController.text,
